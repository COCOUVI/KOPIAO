...
@section('content')
                ...
                <div class="form-card">
                    <div class="card-header">
                        <h2>
                            ...
                            Nouvel Apprenant - Formulaire d'inscription
                        </h2>
                    </div>
                        ...
                        <form action="{{ route('apprenants.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-section active" id="section-1">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            ...
                                            <select class="form-select @error('learning_preference') is-invalid @enderror"
                                                ...
                                                <option value="online"
                                                    {{ old('learning_preference') == 'online' ? 'selected' : '' }}>En ligne
                                                </option>
                                                <option value="in_person"
                                                    {{ old('learning_preference') == 'in_person' ? 'selected' : '' }}>En
                                                    présentiel</option>
                                                <option value="hybrid"
                                                    {{ old('learning_preference') == 'hybrid' ? 'selected' : '' }}>Hybride
                                                </option>
                                            </select>
                                            ...
                                            @enderror
                                            <div class="form-text">
                                                <i class="fas fa-info-circle"></i> Définissez le mode d'apprentissage
                                                préféré
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-section-actions">
                                    ...
                                    <button type="button" class="btn btn-primary next-section" data-current="1"
                                        data-next="2">
                            ...
                            <div class="form-section" id="section-2" style="display: none;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            <label for="password_confirmation" class="form-label">
                                                <i class="fas fa-lock"></i> Confirmation <span class="required">*</span>
                                            </label>
                                ...
                                <div class="form-section-actions">
                                    <button type="button" class="btn btn-outline prev-section" data-current="2"
                                        data-prev="1">
                                        <i class="fas fa-arrow-left"></i> Précédent
                                    </button>
                                    <button type="button" class="btn btn-primary next-section" data-current="2"
                                        data-next="3">
                                        Suivant <i class="fas fa-arrow-right"></i>
                                    </button>
                                </div>
                            ...
                            <div class="form-section" id="section-3" style="display: none;">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control @error('bio') is-invalid @enderror" id="bio" name="bio" rows="4"
                                        placeholder="Décrivez brièvement l'apprenant (parcours, objectifs, etc.)">{{ old('bio') }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            ...
                                            <div class="card settings-card">
                                                <!-- Aucun champ caché nécessaire avec cette méthode -->
                                                ...
                                                <div class="form-check form-switch mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="notify_email_checkbox" name="notify_email" value="1"
                                                        {{ old('notify_email', true) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="notify_email_checkbox">
                                                        <i class="fas fa-bell"></i> Notifications par email
                                                    </label>
                                                </div>

                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="notify_push_checkbox" name="notify_push" value="1"
                                                        {{ old('notify_push', true) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="notify_push_checkbox">
                                ...
                                <div class="form-section-actions">
                                    <button type="button" class="btn btn-outline prev-section" data-current="3"
                                        data-prev="2">
                                        <i class="fas fa-arrow-left"></i> Précédent
                                    </button>
                                    <button type="button" class="btn btn-primary next-section" data-current="3"
                                        data-next="4">
                                        Suivant <i class="fas fa-arrow-right"></i>
                                    </button>
                                </div>
                            ...
                            <div class="form-section" id="section-4" style="display: none;">
                                ...
                                <div class="confirmation-summary">
                                    <div class="summary-card">
                                        <h4><i class="fas fa-user-check"></i> Récapitulatif</h4>
                                    ...
                                    <div class="confirmation-message">
                                        ...
                                        <p>Vérifiez les informations ci-dessus avant de créer l'apprenant.</p>
                                    </div>
                                </div>

                                <div class="form-section-actions">
                                    <button type="button" class="btn btn-outline prev-section" data-current="4"
                                        data-prev="3">
                                        <i class="fas fa-arrow-left"></i> Précédent
                                    </button>
                                    <button type="submit" class="btn btn-primary" id="submitForm">
                                        <i class="fas fa-user-plus"></i> Créer l'Apprenant
                                    </button>
                                </div>
                            </div>
                        </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Bouton annuler
            const cancelBtn = document.querySelector('.btn-secondary[onclick="window.history.back()"]');
