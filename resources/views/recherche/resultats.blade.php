                    ...
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="subject" class="form-control form-control-lg border-primary-subtle"
                                placeholder="Ex : Mathématiques, Anglais..." id="subjectInputResults" value="{{ request('subject') }}">
                        </div>
            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="d-flex gap-2">
                        @if(request('subject'))
                        <span class="badge bg-primary bg-opacity-10 text-primary p-2 rounded-pill d-flex align-items-center">
                        ...
                        @if(request('city'))
                        <span class="badge bg-danger bg-opacity-10 text-danger p-2 rounded-pill d-flex align-items-center">
                        ...
                        <span class="badge bg-success bg-opacity-10 text-success p-2 rounded-pill d-flex align-items-center">
                            ...
                            @else
                                Les deux
                            @endif
                            <a href="{{ request()->fullUrlWithoutQuery('learning_preference') }}" class="text-danger ms-2">
                                <i class="bi bi-x"></i>
                            </a>
                        </span>
                        @endif
            ...
            <div class="col-md-8">
                <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                    <div class="card-body p-5 text-center">
                        ...
                        <p class="text-muted mb-4">Essayez d'élargir vos critères de recherche ou consultez nos suggestions ci-dessus.</p>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="text-muted small mb-0">
                                ...
                                Professeur de {{ explode(',', $tuteur->subjects)[0] ?? 'matières' }}
                            </p>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex flex-wrap gap-1">
                                @foreach(array_slice(explode(',', $tuteur->subjects), 0, 3) as $subject)
                                <span class="badge bg-light text-dark border p-1 rounded">
                                    {{ trim($subject) }}
                                </span>
                                @endforeach
                                @if(count(explode(',', $tuteur->subjects)) > 3)
                                <span class="badge bg-light text-dark border p-1 rounded">
                                    +{{ count(explode(',', $tuteur->subjects)) - 3 }}
                                </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row g-2 mb-3">
                            <div class="col-12">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="text-muted small">{{ $tuteur->city ?? 'Non spécifiée' }}</span>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="d-flex align-items-center">
                                    <i class="bi bi-cash-coin text-success me-2"></i>
                                    <span class="text-muted small">À partir de 20€/h</span>
                                </div>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupHorizontalScroll(containerClass, prevBtnClass, nextBtnClass) {
        ...
        function autoScrollContent() {
            if (autoScroll && container.scrollWidth > container.clientWidth) {
                container.scrollBy({ left: direction * 1, behavior: 'auto' });
    ...
    setupHorizontalScroll('.villes-scroll', '.btn-scroll-prev-villes-results', '.btn-scroll-next-villes-results');
...
.matiere-badge-results, .ville-badge-results {
    flex-shrink: 0;
