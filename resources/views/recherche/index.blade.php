...
@section('content')
    ...
    <div class="professeurs-page">
        ...
        <div class="container-fluid professors-main-container">
            <div class="row">
                <!-- Section principale des professeurs - Pleine largeur -->
                <div class="col-12">
                    <!-- Grille des professeurs - 4 par ligne -->
                    <div class="professors-grid" id="professorsGrid">
                        @foreach ($professeurs as $professeur)
                            <div class="professor-card-container" data-aos="zoom-in-up"
                                data-aos-delay="{{ ($loop->index % 4) * 100 }}">
                                <div class="professor-card">
                                    <!-- Photo de fond avec overlay -->
                                    <div class="professor-bg-image"
                                        onclick="openImageModal('{{ asset('storage/' . $professeur->photo_path) }}', '{{ $professeur->firstname }} {{ $professeur->lastname }}', '{{ $professeur->bio ?? '' }}')">
                                        ...
                                        @else
                                            <div class="default-bg">
                                                <div class="initials">
                                                    {{ substr($professeur->firstname, 0, 1) }}{{ substr($professeur->lastname, 0, 1) }}
                                                </div>
                                            </div>
                                        @endif
                                        ...
                                        <!-- Badge en ligne -->
                                        <div
                                            class="online-status {{ $professeur->learning_preference == 'online' ? 'online' : 'offline' }}">
                                    ...
                                    <div class="professor-content">
                                        ...
                                        @if ($professeur->rate_per_hour)
                                            <div class="professor-rate">
                                                <div class="rate-badge">
                                                    ...
                                                    <span
                                                        class="amount">{{ number_format($professeur->rate_per_hour, 0, ',', ' ') }}</span>
                                        ...
                                        <div class="professor-actions">
                                            ...
                                            <!-- Voir profil -->
                                            <a href="#" class="action-btn profile-btn" data-bs-toggle="tooltip"
                                                data-bs-title="Voir profil">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            subjectContainers.forEach(container => {
                ...
                if (containerWidth > parentWidth) {
                    const duration = (containerWidth / 50) * 1000;
        ...
        function openImageModal(imageSrc, name, bio) {
